...
# ------------------------------------------------------------
Q01 = "B"   # frutas[-2] = "laranja" (lista após append: ["maçã","abacaxi","uva","laranja","manga"])
...
# ------------------------------------------------------------
Q02 = "C"   # tuplas são imutáveis → TypeError
...
# E) "Ana"
# ------------------------------------------------------------
Q03 = "C"   # .get() retorna o valor padrão quando a chave não existe
...
# E) [9.0, 7.0]
# ------------------------------------------------------------
Q05 = "B"   # ordenado desc: [9.0,8.5,7.0,6.0,5.5] → [1:3] = [8.5, 7.0]
...
# E) 8
# ------------------------------------------------------------
Q07 = "A"   # turma_a - turma_b = {"Ana","Bruno"} → len = 2
...
# E) []
# ------------------------------------------------------------
Q10 = "C"   # Carlos média 8.0 ✓, Beatriz 9.67 ✓, Diego 5.0 ✗
...
# ------------------------------------------------------------
Q13 = "C"   # x=99 é local → imprime 99 depois 10 (global inalterado)
...
# E) 8
# ------------------------------------------------------------
Q15 = "B"   # dobrar aplicado em [1,2,3,4] → [2,4,6,8]
...
# ------------------------------------------------------------
Q17 = "A"   # info.get("CARGO") = "Professor" e __doc__[:10] = "Registra i"
