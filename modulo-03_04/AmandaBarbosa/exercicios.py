...
# E) 8
# ------------------------------------------------------------
Q07 = "A" #quando faz a diferença fica apenas ana e bruno, os outros dois repetem no outro conjunto, sobrando 2
...
# ------------------------------------------------------------
Q09 = "D" #soma os membros dos dicionarios e coloca na variavel resultado
...
# E) []
# ------------------------------------------------------------
Q10 = "C" #mostra os alunos com media maior que 7 de acordo com o tamanho da lista, no caso 3.
...
# ------------------------------------------------------------
Q11 = "C" #pois não retorna nada pra printar
...
# E) None e None
# ------------------------------------------------------------
Q12 = "C" #Porque quando passamos apenas ana, fico o olá como mensagem padrão e no seguinte passamos os dois parametros
...
# ------------------------------------------------------------
Q13 = "C" #quando printa dentro da funcao retorna o valor que esta dentro 
#do escopo, quando sai da funcao apesar de mudar, não mudou no escopo global
...
# ------------------------------------------------------------
Q14 = "C"
#a resposta pega o valor maior dentro da lista e diminui pelo menor valor
...
# ------------------------------------------------------------
Q16 = "D"
#faz a multiplicação 4x3x2x1, quando chega no 1, temos a condição de parada da função
